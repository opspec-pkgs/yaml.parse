[![Build Status](https://github.com/opspec-pkgs/yaml.parse/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/yaml.parse/actions?query=workflow%3Abuild+branch%3Amain)
